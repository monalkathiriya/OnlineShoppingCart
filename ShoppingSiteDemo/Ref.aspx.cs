...
public partial class Ref : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        if (ca > 0)
        {
            ...
            Response.AddHeader("Refresh", "2,url=Ref.aspx");
        ...
        else
        {
            ...
            string imgLoc = "C:/Program Files (x86)/IIS Express/Images/5.jpeg";
            byte[] img = null;
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            string imgLoc = "C:/Program Files (x86)/IIS Express/Images/6.jpeg";
            byte[] img = null;
            FileStream fs = new FileStream(imgLoc, FileMode.Open, FileAccess.Read);
            BinaryReader br = new BinaryReader(fs);
            img = br.ReadBytes((int)fs.Length);
    ...
    protected void Button3_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            string imgLoc = "C:/Program Files (x86)/IIS Express/Images/7.jpeg";
            byte[] img = null;
            FileStream fs = new FileStream(imgLoc, FileMode.Open, FileAccess.Read);
            BinaryReader br = new BinaryReader(fs);
            img = br.ReadBytes((int)fs.Length);
