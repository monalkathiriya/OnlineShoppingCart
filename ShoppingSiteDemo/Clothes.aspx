    ...
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        <li class="breadcrumb-item">
          <asp:HyperLink ID="HyperLink6" navigateUrl="~/ProductPage.aspx" runat="server">E-cart</asp:HyperLink>
        </li>
      ...
      <div class="row">
        <div class="col-12">
          <h1>Clothes</h1>
           ...
           <asp:Table  runat="server" CellSpacing="15" CellPadding="15" ForeColor="#343a40">
                 <asp:Tablerow runat="server">
                   <asp:TableCell runat="server">
                        <asp:label runat="server" ID="Label1" Visible="false" Font-Bold="true">1</asp:label>
                    </asp:TableCell>
                    <asp:TableCell runat="server">
                        <asp:label runat="server" ID="Label2" Visible="false" Font-Bold="true">2</asp:label>
                    </asp:TableCell>
                    <asp:TableCell runat="server">
                        <asp:label runat="server" ID="Label3" Visible="false" Font-Bold="true">3</asp:label>
                    </asp:TableCell>
                </asp:Tablerow>
                            <asp:TableRow runat="server">
                                <asp:TableCell runat="server">
                                    <asp:Image ID="Image1" runat="server" ImageUrl="~/Images/19.jpg" Height="260px" CssClass="img-responsive"></asp:Image>
                                </asp:TableCell>
                                <asp:TableCell runat="server">
                                    <asp:Image ID="Image2" runat="server" ImageUrl="~/Images/17.jpg" Height="260px"></asp:Image>
                                </asp:TableCell>
                                <asp:TableCell runat="server">
                                    <asp:Image ID="Image3" runat="server" ImageUrl="~/Images/18.jpg" Height="260px"></asp:Image>
                                </asp:TableCell>
                            </asp:TableRow>
               <asp:Tablerow runat="server">
                   <asp:TableCell runat="server">
                        <asp:label runat="server" ID="L1" Font-Bold="true">United Colors of Benetton Men's Cotton Polo</asp:label>
                    </asp:TableCell>
                    <asp:TableCell runat="server">
                        <asp:label runat="server" ID="L2" Font-Bold="true">Roadster Men Beige Printed Round Neck T-shirt</asp:label>
                    </asp:TableCell>
                    <asp:TableCell runat="server">
                        <asp:label runat="server" ID="L3" Font-Bold="true">Roadster Men Solid Round Neck T-shirt</asp:label>
                    </asp:TableCell>
                </asp:Tablerow>
                  <asp:Tablerow runat="server">
                   <asp:TableCell runat="server">
                    ...
                    <asp:Tablerow runat="server">
                   <asp:TableCell runat="server">
                        <asp:label runat="server" ID="L4"  Font-Bold="true">900</asp:label>
                    </asp:TableCell>
                    <asp:TableCell runat="server">
                        <asp:label runat="server" ID="L5" Font-Bold="true">600</asp:label>
                    </asp:TableCell>
                    <asp:TableCell runat="server">
                        <asp:label runat="server" ID="L6" Font-Bold="true">800</asp:label>
                    </asp:TableCell>
                </asp:Tablerow>
