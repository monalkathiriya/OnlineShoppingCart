...
public partial class Clothes : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        if (ca > 0)
        {
            ...
            Response.AddHeader("Refresh", "2,url=Clothes.aspx");

        }
        else
        {

            string imgLoc = "C:/Program Files (x86)/IIS Express/Images/12.jpg";
            byte[] img = null;
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        {
            string imgLoc = "C:/Program Files (x86)/IIS Express/Images/13.jpg";
            byte[] img = null;
            FileStream fs = new FileStream(imgLoc, FileMode.Open, FileAccess.Read);
            BinaryReader br = new BinaryReader(fs);
            img = br.ReadBytes((int)fs.Length);
    ...
    protected void Button3_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            string imgLoc = "C:/Program Files (x86)/IIS Express/Images/16.jpg";
            byte[] img = null;
            FileStream fs = new FileStream(imgLoc, FileMode.Open, FileAccess.Read);
            BinaryReader br = new BinaryReader(fs);
            img = br.ReadBytes((int)fs.Length);
